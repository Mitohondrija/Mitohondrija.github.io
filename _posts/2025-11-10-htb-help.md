...
After some meddling with the version 2.0.2 I found out that it contains the [README.md](http://README.md) file that mentions a version of the software. I will try to search for this file on the target machine, and try to find out which version is on it. I found out that it’s a 1.0.2, the older version that we have two exploits for.
